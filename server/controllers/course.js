...
exports.createCourse = async (req,res) => { 
    try{
        ...
        let {courseName , courseDescription , whatYouWillLearn , price  , category , status , instructions:_instructions , tag:_tag} = req.body;
        ...
        const newCourse = await Course.create({
            courseName,
            courseDescription,
            instructor:instructorDetails._id, // to store object id in DB
...
exports.allCourses = async (req,res) => {
    try{
        ...
        const allCourses = await Course.find({status:"Published"},{courseName:true,price:true,thumbnail:true,instructor:true,ratingAndReview:true,enrolledStudents:true,}).populate("instructor").exec();
...
exports.editCourse = async (req , res) => {
    try{
        ...
        // if thumbnail not found,update it
        if(req.files){
        ...
        // updates only fields that are present in requrest
