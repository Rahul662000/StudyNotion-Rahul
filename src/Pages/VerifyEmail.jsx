...
const VerifyEmail = () => {
    ...
    useEffect(()=>{
        if(!signupData)  {
            navigate("/signup")
        }                      //useEffect on first render  if signupdata not available go to signup
    },[])
            ...
            loading ? (
                ...
                <div className='max-w-[500px] p-4 lg:p-8'>
                    ...
                    <div className='mt-6 flex items-center justify-between'>
                        ...
                        <button onClick={()=> dispatch(sendOtp(signupData.email,navigate))} className='flex items-center text-blue-100 gap-x-2'> <RxCountdownTimer /> 
                            Resend it
                        </button>
                    </div>
