...
const VideoDetails = () => {
    ...
    useEffect(() => {
            ...
            ;(async () => {
                ...
                {    
                    ...
                    // allsumeing all others are present
    ...
    const goToNextVideo = () => {
        ...
        // current subsection videos except last videos
                            ...
                            <div style={{backgroundImage:"linear-gradient(to top , rgb(0,0,0) , rgba(0,0,0,0.7) , rgba(0,0,0,0.5) , rgba(0,0,0,0.1))"}} className='full absolute inset-0 z-[100] grid h-full place-content-center font-inter'>
                                {
                                    ...
                                    !completedLectures.includes(subSectionId) && (
                                        <IconButton disabled={loading} onClick={ () => handleLectureCompletion() } text={!loading ? "Mark as Completed" : "Loading..."} customClasses="text-xl max-w-max px-4 mx-auto"/>
