            ...
            <div className='p-6'>
                ...
                <div className='flex items-center justify-center gap-x-4'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-richblack-5'>Posting Publicaly</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='mt-6 flex flex-col items-center'>
                    ...
                    <div className='flex w-11/12 flex-col space-y-2'>
                        ...
                        <textarea id='courseExperience' placeholder='Add your experience here... ' {...register("courseExperience",{required:true})} className='form-style min-h-[130px] w-full resize-x-none'/>
                        {
