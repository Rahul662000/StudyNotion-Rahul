  ...
  return (
    <div>
        <div>
                ...
                <p className='text-richblack-300 text-center text-lg font-semibold mt-1'>Learn to Build Anything You Can Imagine</p>
            ...
            <div className='lg:absolute gap-10 justify-center lg:gap-0 flex flex-wrap lg:justify-between w-full lg:bottom-[0] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-7 lg:px-0 px-3'>
            {
