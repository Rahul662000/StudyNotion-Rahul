...
import RequiredmentField from './RequiredmentField'
...
const CourseInformationForm = () => {
    ...
    const isFormUpdated = () => {
        ...
        if(currentValues.courseTitle !== course.courseName || 
            ...
            currentValues.courseCategory._id !== course.cateogry._id|| 
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6'>
        ...
        {/* tags - done by your self*/}
        <ChipInput label="Tags" name="courseTags" placeholder="Enter tag and press Enter" register={register} errors={errors} setValue={setValue} getValues={getValues}/>

        {/* Thumbnail - create yourself */}
