      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='my-6 mb-8'>
          ...
          <label htmlFor='public' className='inline-flex items-center text-lg'>
            <input type='checkbox' id='public' {...register("public")} className='border-neutral-500 h-4 w-4 rounded bg-richblack-500 text-richblack-400 focus:ring-richblack-5'/>
