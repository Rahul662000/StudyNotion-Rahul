...
const Modal = ({modalData}) => {
  return (
    <div className='fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-white bg-opacity-20 backdrop-blur-md'>   
        <div className='w-11/12 max-w-[450px] rounded-lg border border-richblack-400 bg-richblack-800 p-6'>
            ...
            <div className='flex items-center gap-x-4'>
                <IconButton text={modalData?.btn1text} onClick={modalData?.btn1Handler} />
